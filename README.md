...
```sh
curl -o- https://raw.githubusercontent.com/andrewscwei/vpm/v1.9.0/install.sh | bash
```

or Wget:

```sh
wget -qO- https://raw.githubusercontent.com/andrewscwei/vpm/v1.9.0/install.sh | bash
```
