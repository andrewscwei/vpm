...
```sh
curl -o- https://raw.githubusercontent.com/andrewscwei/vpm/v0.11.0/install.sh | bash
```

or Wget: 

```sh
wget -qO- https://raw.githubusercontent.com/andrewscwei/vpm/v0.11.0/install.sh | bash
```
